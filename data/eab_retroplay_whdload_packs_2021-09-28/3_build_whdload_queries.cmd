...
:: Magazines
powershell -ExecutionPolicy Bypass -File ..\..\build_whdload_queries.ps1 -entriesFiles "filtered\magazines_filtered.csv" -queryPatchesFile "screenshots\magazines_screenshot_query_patches.csv" -queriesFile "screenshots\magazines_screenshots\magazines_screenshot_queries.csv" -addWhdloadSlaveName -addWhdloadSlaveCopy
powershell -ExecutionPolicy Bypass -File ..\..\build_whdload_queries.ps1 -entriesFiles "filtered\magazines_filtered.csv" -queryPatchesFile "details\magazines_detail_query_patches.csv" -queriesFile "details\magazines_details\magazines_detail_queries.csv" -addWhdloadSlaveName -addWhdloadSlaveCopy
